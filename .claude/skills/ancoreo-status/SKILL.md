...
- `CLAUDE.md` (raiz do projeto) — visão, roadmap, regras.
- `docs/CRONOGRAMA.md` — roadmap/estado no tempo; **pode estar DESATUALIZADO**, tratar como pista. A verdade é git + banco.
...
```bash
npx tsc --noEmit       # tem que dar verde
